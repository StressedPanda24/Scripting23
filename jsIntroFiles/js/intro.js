...
console.log("My favourite animal is a "+animal+"!:D");
...
document.getElementById('column1').innerHTML="<h3>Holy Moly ! I changed the page what?!<h3>";
document.getElementById('column1').innerHTML+="<p>Woah! I can add more to it! So crazy</p>";
document.getElementById('column1').innerHTML+="<p>It just keeps going how crazy is that!!</p>";
...
document.getElementById('column2').style.backgroundColor="#123456";
...
if(weapon=="Goose"){
    console.log("You got Goosed");
}else if(weapon=="Shrimp"){
    console.log("Got you Shrimped!");
}else{
...
//if the weapon is Goose then the damage points are 50
//but if the weapon is Shrimp then the damage is 25
